...
//      //1: blue - DIG 2 - a
//      if(digitalRead(dig2) == HIGH){
//        Keyboard.release('a');
//        delay(2);
//      }
//      else if(digitalRead(dig2) == LOW){
//        Keyboard.press('a');
//        delay(10);
//      } 
//      //1: purple - DIG 3 - b
//      if(digitalRead(dig3) == HIGH){
//        Keyboard.release('b');
//        delay(2);
//      }
//      else if(digitalRead(dig3) == LOW){
//        Keyboard.press('b');
//        delay(10);
//      }
      //1: grey - DIG 4 - c 
      if(digitalRead(dig4) == LOW){
        Keyboard.release('c');
        delay(2);
      }
      else if(digitalRead(dig4) == HIGH){
        Keyboard.press('c');
        delay(10);
      } 
      //1: White - DIG 5 - d
      if(digitalRead(dig5) == LOW){
        Keyboard.release('d');
        delay(2);
      }
      else if(digitalRead(dig5) == HIGH){
        Keyboard.press('d');
        delay(10);
      }
//      //1: Black - DIG 6 - e
//      if(digitalRead(dig6) == HIGH){
//        Keyboard.release('e');
//        delay(2);
//      }
//      else if(digitalRead(dig6) == LOW){
//        Keyboard.press('e');
//        delay(10);
//      }
//
//      //2: blue - DIG 7 - f
//      if(digitalRead(dig7) == HIGH){
//        Keyboard.release('f');
//        delay(2);
//      }
//      else if(digitalRead(dig7) == LOW){
//        Keyboard.press('f');
//        delay(10);
//      } 
//      //2: purple - DIG 8 - g
//      if(digitalRead(dig8) == HIGH){
//        Keyboard.release('g');
//        delay(2);
//      }
//      else if(digitalRead(dig8) == LOW){
//        Keyboard.press('g');
//        delay(10);
//      }
      //2: grey - DIG 9 - h 
      if(digitalRead(dig9) == LOW){
        Keyboard.release('h');
        delay(2);
      }
      else if(digitalRead(dig9) == HIGH){
        Keyboard.press('h');
        delay(10);
      } 
      //2: White - DIG 10 - i
      if(digitalRead(dig10) == LOW){
        Keyboard.release('i');
        delay(2);
      }
      else if(digitalRead(dig10) == HIGH){
        Keyboard.press('i');
        delay(10);
      }
//      //2: Black - DIG 11 - j
//      if(digitalRead(dig11) == HIGH){
//        Keyboard.release('j');
//        delay(2);
//      }
//      else if(digitalRead(dig11) == LOW){
//        Keyboard.press('j');
//        delay(10);
//      }
  }
